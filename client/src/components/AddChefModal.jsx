  ...
  return (
    <>
      ...
      <div
        ...
        id='addChefModal'
        aria-labelledby='addChefModalLabel'
        aria-hidden='true'
      >
        <div className='modal-dialog'>
          <div className='modal-content'>
            <div className='modal-header'>
              <h5 className='modal-title' id='addChefModalLabel'>
                Add Chef
              </h5>
              <button
                type='button'
